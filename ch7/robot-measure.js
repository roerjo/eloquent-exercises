...
function compareRobots(robot1, memory1, robot2, memory2) {
  ...
  for (let i = 0; i < 100; i++) {
    ...
    turns1 += runRobot(task, robot1, memory1);
    turns2 += runRobot(task, robot2, memory2);
  }
  console.log(turns1 / 100, turns2 / 100);
}
